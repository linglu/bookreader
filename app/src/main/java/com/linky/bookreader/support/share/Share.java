package com.linky.bookreader.support.share;
...
import com.linky.bookreader.callback.BaseUiListener;
...
public class Share {
    ...
    private static Tencent mTencent = Tencent.createInstance(QQ_APP_ID, VoiceApp.getAppContext());;
